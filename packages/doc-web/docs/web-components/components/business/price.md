...
<TabsLink id="ti-price-api" />

## 用法示例
#### 基本用法

```html showLineNumbers
<ti-price label="销售价" unit="$" prefix="最低" value="29.99" suffix="起"></ti-price>
```
