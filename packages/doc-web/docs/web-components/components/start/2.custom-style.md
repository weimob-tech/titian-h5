...
2. `外部样式类`: 组件库开放了大量的外部样式类供开发者使用，具体的样式类名称可查阅对应组件的 **外部样式类** 部分。外部样式类的相关知识背景请查阅 [微信小程序文档](https://developers.weixin.qq.com/miniprogram/dev/framework/custom-component/wxml-wxss.html#%E5%A4%96%E9%83%A8%E6%A0%B7%E5%BC%8F%E7%B1%BB)
...
<Tabs>
  ...
  <TabItem value="wxss" label="index.wxss" default>
