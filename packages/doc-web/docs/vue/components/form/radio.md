...
import { TiRadio, TiRadioGroup, TiRadioButton } from 'titian-h5-vue';
```
...
import { TiRadio } from 'titian-h5-vue';
</script>
```
...
<script lang="ts" setup>
import { TiRadioButton } from 'titian-h5-vue';
</script>
```
...
<script lang="ts" setup>
import { TiRadioButton, TiImage } from 'titian-h5-vue';
</script>
```
...
<script lang="ts" setup>
import { TiRadioGroup, TiRadio, TiRadioButton } from 'titian-h5-vue';
</script>
```
...
<script lang="ts" setup>
import { TiRadioGroup } from 'titian-h5-vue';
</script>
```
