...
import { TiCell, TiCellGroup } from 'titian-h5-vue';
```
...
| align-items    | `string`  | 否       | -          | 单元格的横向对其方式, 具体值可见 [align-items](https://developer.mozilla.org/en-US/docs/Web/CSS/align-items)                                         | -                                                                 |
