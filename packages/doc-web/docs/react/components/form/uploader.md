...
| imageParams       | `Record<string, any>`             | 否       | {}                  | 上传图片参数                                           | -        |
| videoParams       | `Record<string, any>`             | 否       | {}                  | 上传视频参数                                           | -        |
| fileParams        | `Record<string, any>`             | 否       | {}                  | 上传文件参数                                           | -        |
| imageResultFormat | <code>(string \| number)[]</code> | 否       | []                  | 图片参数                                               | -        |
| videoResultFormat | <code>(string \| number)[]</code> | 否       | []                  | 视频参数                                               | -        |
| fileResultFormat  | <code>(string \| number)[]</code> | 否       | []                  | 文件参数                                               | -        |
