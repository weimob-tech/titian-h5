...
import SearchSvg from '@site/src/asset/svg/search.svg';
...
function DocSearch({ contextualSearch, externalUrlRegex, ...props }) {
  ...
  const onOpen = useCallback(() => {
    importDocSearchModalIfNeeded().then(() => {
      ...
      setIsOpen(true);
      sessionStorage.setItem('searchModalIsOpen', true);
    });
  }, [importDocSearchModalIfNeeded, setIsOpen]);
  const onClose = useCallback(() => {
    setIsOpen(false);
    sessionStorage.removeItem('searchModalIsOpen');
  ...
  return (
    <>
      ...
      {/* <DocSearchButton
        ...
        onClick={onOpen}
        ref={searchButtonRef}
        translations={{ buttonText: '搜索关键词' }}
      /> */}
      <SearchSvg className="search-icon" onClick={onOpen}></SearchSvg>
