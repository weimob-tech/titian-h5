...
import { TiDropdownItemProps, TiDropdownMenuProps, TiDropdownMenu, TiDropdownItem } from '@titian-design/mobile-vue';
import { ref } from 'vue';
...
interface Attrs extends TiDropdownMenuProps {
