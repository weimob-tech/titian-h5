...
const config: Config = {
  ...
  configs: {
    recommended: {
      ...
      plugins: ['@typescript-eslint', '@titian-design'],
      extends: [
        /**
         * airbnb 规范
      ...
      rules: {
        ...
        // 自定义
        '@titian-design/no-more-args': 'error',

        '@titian-design/no-option-key': 'warn',

        '@titian-design/check-life-items': 'warn',

        '@titian-design/line-comment': 'error',
      },
    },
  },
};
