...
import { Timout, TransitionName } from "./components/common/basic/transition";
...
import { Timout as Timout1 } from "./components/transition/index";
export namespace Components {
    ...
    interface TiCollapse {
        ...
        "icon"?: string;
        "options": (OmitType<Components.TiCollapseItem, (...agrn: any) => any> & { content: string })[] | string;
        "repel"?: boolean;
        "rightIcon"?: string;
